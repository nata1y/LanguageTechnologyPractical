...
# An example of different formulations of the same question
    # What is the president of Japan?
...
def print_example_queries():
    ...
    print("2. What city is the capital of Poland?")
    print("3. Who is the CEO of Samsung?")
    print("4. What country is Berlin the capital of?")
    print("5. What person is the head of state of North Korea?")
    print("6. State the surface area of Tokyo")
    print("7. Name the president of Zimbabwe")
    print("8. Name the capital of the Andaman and Nicobar Islands")
    print("9. How is the capital city of Iceland named?")
    print("10. What person is the president of Romania?")
